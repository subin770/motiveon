...
<body>
	<div class="wrap">
		...
		<section class="panel">
				...
				<tbody>
					<c:forEach var="d" items="${list}">
						<tr>
							...
							<td><fmt:formatDate value="${not empty d.draftAt ? d.draftAt : d.ddate}" pattern="yyyy-MM-dd" /></td>
							<td><c:out value="${not empty d.formNo ? d.formNo : d.formNo}" /></td>
							...
							<td><c:out value="${not empty d.signNo ? d.signNo : d.signNo}" /></td>
			...
			<form action="${pageContext.request.contextPath}/approval/tempList" method="get" style="display:none"></form>
...
function toggleAll(chk){
  document.querySelectorAll('tbody input[type="checkbox"]').forEach(b=>b.checked=chk.checked);
}
</script>
</body>
</html>
